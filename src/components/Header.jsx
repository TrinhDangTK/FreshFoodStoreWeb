...
export default function Header({ setActivePage, activePage }) {
  ...
  const categories = [
    { name: 'HOT DEAL', id: 'hot-deal', highlight: true },
    { name: 'TD Mart Kitchen Homemade', id: 'homemade', highlight: false },
    { name: 'Thực Phẩm Sơ Chế', id: 'processed', highlight: false },
    { name: 'Rau Củ Quả Các Loại', id: 'vegetables', highlight: false },
    { name: 'Trái Cây Tươi', id: 'fruits', highlight: false },
    { name: 'Hải Sản Tươi Sống', id: 'seafood', highlight: false },
  ];
